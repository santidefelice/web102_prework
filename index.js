...
const displayStr = `Our company has raised a total of $${amountRaised.toLocaleString()} for
${GAMES_JSON.length} games. Currently there ${numOfUnfundedGames === 1 ? 'is' : 'are'} ${numOfUnfundedGames} unfunded ${numOfUnfundedGames === 1 ? 'game' : 'games'} remaining.`;
